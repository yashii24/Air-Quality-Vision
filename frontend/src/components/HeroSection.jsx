...
const HeroSection = () => {
  return (
    <section className="w-full bg-gray-100 px-[10rem] py-6 flex flex-col md:flex-row items-center justify-between">
        <div className="max-w-lg">
            ...
            <div className="flex gap-4">
                ...
                <Link to="/stations" className="bg-white border px-4 py-2 rounded">Stations</Link>
            </div>
        </div>
